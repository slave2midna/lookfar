    ...
    const dlg = new Dialog({
        ...
        render: async (html) => {
            ...
            `);
                        ...
                        $img.on("click", () => {
                            sock?.executeAsGM?.(IF_MSG.MaterialsRemove, {
                                index: i
                            });
                        });
            ...
            $materialsDrop
                ...
                .on("drop", async (ev) => {
                    ...
                    try {
                        ...
                        if (!data?.uuid) return;
                        sock?.executeAsGM?.(IF_MSG.MaterialsAdd, {
                            uuid: data.uuid
                        });
                    } catch (e) {
    ...
    const dlg = new Dialog({
        ...
        render: async (html) => {
            ...
            if (game.user.isGM) {
                ...
                html.data("ifMaterials", _materials);
                sock?.executeForEveryone?.(IF_MSG.HostOpen, {
                    hostId: game.user.id
                });
            ...
            const broadcastForgeState = () => {
                ...
                sock.executeForEveryone(IF_MSG.UIStateReplace, {
                    state
                });
            };
